...
Namespace Controls.NHLStats
    Public Class TeamCell
        ...
        Private Function PaintPrivate(ByVal graphics As Graphics,
                                      ...
                                      ByVal computeContentBounds As Boolean,
                                      ByVal computeErrorIconBounds As Boolean,
                                      ByVal paint As Boolean) As Rectangle
                    ...
                    If paint Then
                        ...
                        If PaintContentForegroundCheck(paintParts) Then
                            ...
                            TextRenderer.DrawText(graphics,
                                                  ...
                                                  cellStyle.Font,
                                                  valBounds,
                                                  If(cellSelected, cellStyle.SelectionForeColor, cellStyle.ForeColor),
                                                  flags)
                        End If
                    End If
                End If
        ...
        Friend Shared Function ComputeTextFormatFlagsForCellStyleAlignment(
                                                                          ByVal rightToLeft As Boolean,
                                                                          ByVal alignment As DataGridViewContentAlignment,
