...
Friend Class English
    ...
    '''<summary>
    '''  Looks up a localized string similar to When the game starts (play ball).
    '''</summary>
    ...
    '''<summary>
    '''  Looks up a localized string similar to An error happened! {0}Click on [?] (top-right corner) to get to MLBGames documentation and search for your issue.{0}If not found, click on &quot;Copy to clipboard&quot; and paste it in a new thread on /r/mlb_games or open a new issue on our GitHub page. Make sure it was not already posted by someone else..
    '''</summary>
    ...
    '''<summary>
    '''  Looks up a localized string similar to Visit our subreddit /r/mlb_games to chat with other redditors about MLBGames.
    '''</summary>
